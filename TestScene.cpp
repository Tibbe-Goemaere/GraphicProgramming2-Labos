...
void TestScene::Initialize()
{
	...
	m_SceneContext.GetCamera()->SetForward({ 0.f,-0.3f,1.f });

	//Torus
	auto pTorus = new TorusPosColorNorm(8.f, 50, 1.f, 10, XMFLOAT4{ Colors::SteelBlue });
	AddGameObject(pTorus);

	//Cylinder
	auto pCylinder = new CylinderPosColorNorm(1.5f, 10, 4.f, XMFLOAT4(Colors::DarkGoldenrod));
...
void TestScene::Update()
{
	...
	m_pBox->RotateDegrees(0.f,90 * totalTime,0.f);
